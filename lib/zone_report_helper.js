        ...
        .then(function(){
            ...
            for(i=0; i< result_for_table.length; i++){
                ...
                for(j=0; j< t.length; ++j){
                    z.P_TileCount[j] = t[j].TileCount;
                    z.P_SizeOnDisk[j] = t[j].SizeOnDisk;
                    z.P_TotalGameObjects[j] = t[j].TotalGameObjects;
                    z.P_TotalGameObjects[j] = t[j].TotalGameObjects;
                    z.P_Verts[j] = t[j].Verts;
                    z.P_Components[j] = t[j].Components;
                    z.P_PlaymakerObjects[j] = t[j].PlaymakerObjects;
                    z.P_PlaymakerEvents[j] = t[j].PlaymakerEvents;
                    z.P_EnemySpawners[j] = t[j].EnemySpawners;
                    z.P_Breakables[j] = t[j].Breakables;
                    z.P__created_on[j] = t[j]._created_on;
                }
                v.push(z)
            }
