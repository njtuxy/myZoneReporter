...
var colleciton1, collection2, collection3, collection4, collection5;
...
zone_report.controller('request_controller', function($scope, $http){
    $http.get(zoneReportAddress)
        ...
        .then(function(){
            return $http.get(zoneReportAddress + collection1);
        })
        .then(function(result){
        ...
        .then(function(){
            return $http.get(zoneReportAddress + collection2);
        })
        .then(function(result){
            //post-process results of the second call and return
        ...
        .then(function(){
            return $http.get(zoneReportAddress + collection3);
        })
        .then(function(result){
        ...
        .then(function(){
            return $http.get(zoneReportAddress + collection4);
        })
        .then(function(result){
            zoneReport4 = result['data']["_embedded"]["rh:doc"];
        })
        .then(function(){
            return $http.get(zoneReportAddress + collection5);
        })
        .then(function(result){
        ...
        .then(function(){
            ...
            //$scope.testData1 = bigArray.length;
            //$scope.testData2 = bigArray;
        });
});
