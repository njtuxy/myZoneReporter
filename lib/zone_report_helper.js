...
zone_report.controller('zone_reporter_table', function ($scope, $http) {
    ...
    $scope.showPreviousTileCountChangePencentage = false;

    $scope.toggleTileCountChangePencentage = function() {
        $scope.showTileCountChangePencentage = !$scope.showTileCountChangePencentage;
    }

    $scope.toggleShowPreviousTileCount = function() {
        $scope.showPreviousTileCountChangePencentage = !$scope.showPreviousTileCountChangePencentage;
    }
